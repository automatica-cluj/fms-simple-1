...
describe('Operator e2e test', () => {
  ...
  it('should load Operators', async () => {
    ...
    expect(await operatorComponentsPage.getTitle()).to.eq('ifmSimple1App.operator.home.title');
  ...
  it('should load create Operator page', async () => {
    ...
    expect(await operatorUpdatePage.getPageTitle()).to.eq('ifmSimple1App.operator.home.createOrEditLabel');
  ...
  it('should delete last Operator', async () => {
    ...
    expect(await operatorDeleteDialog.getDialogTitle()).to.eq('ifmSimple1App.operator.delete.question');
