...
describe('Service Tests', () => {
  describe('OperatorWorkShift Service', () => {
    ...
    let elemDefault: IOperatorWorkShift;
    let expectedResult: IOperatorWorkShift | IOperatorWorkShift[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(OperatorWorkShiftService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a OperatorWorkShift', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            startDate: currentDate.format(DATE_TIME_FORMAT),
        ...
        service.create(new OperatorWorkShift()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should delete a OperatorWorkShift', () => {
