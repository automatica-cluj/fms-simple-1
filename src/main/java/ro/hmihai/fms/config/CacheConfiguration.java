...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ro.hmihai.fms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ro.hmihai.fms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, ro.hmihai.fms.domain.User.class.getName());
            createCache(cm, ro.hmihai.fms.domain.Authority.class.getName());
