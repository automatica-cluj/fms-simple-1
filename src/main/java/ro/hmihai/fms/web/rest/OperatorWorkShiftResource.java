...
public class OperatorWorkShiftResource {
    ...
    public ResponseEntity<OperatorWorkShiftDTO> createOperatorWorkShift(@Valid @RequestBody OperatorWorkShiftDTO operatorWorkShiftDTO) throws URISyntaxException {
    ...
    public ResponseEntity<OperatorWorkShiftDTO> updateOperatorWorkShift(@Valid @RequestBody OperatorWorkShiftDTO operatorWorkShiftDTO) throws URISyntaxException {
