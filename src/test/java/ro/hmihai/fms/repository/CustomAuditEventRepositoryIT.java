...
import ro.hmihai.fms.config.audit.AuditEventConverter;
import ro.hmihai.fms.domain.PersistentAuditEvent;
...
import static ro.hmihai.fms.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
